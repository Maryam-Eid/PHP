...
<?php
  ...
  <div class="wrapper">
    ...
    <form action="includes/signup.php" method="POST">
      ...
      <div class="input-box">
      <label for="uid">Screen Name</label>
        <input type="text" placeholder="Enter your screen name" name="uid" required>
      </div>
      <div class="input-box">
      <label for="dob">Date Of Birth</label>
      <input type="date" max="2006-01-01" min="1980-01-01" placeholder="Enter your email" name="dob" required>
      </div>
     ...
     <label for="country">Country</label>
      ...
      <label for="phone">Phone</label>
        <input type="tel" placeholder="Enter your phone" name="phone" maxlength="14" minlength="7" required>
      </div>
      <div class="input-box">
      ...
      <div class="input-box">
      <label for="pwdRepeat">Confirm your password</label>
      <input type="password" placeholder="Confirm your password" name="pwdRepeat" required>
      </div>
      <div class="policy">
        <input type="checkbox">
...
<!-- 
  ...
  CREATE TABLE users (
      ...
      users_phone VARCHAR(20) UNIQUE NOT NULL,
